...
async function seedDatabase() {
  try {
    console.log('🏋️‍♂️ GymTiva - Poblando Base de Datos');
    console.log('=====================================');
    ...
    console.log('🌐 Ve a: http://localhost:3000/rutinas');
    ...
    if (error.message.includes('network')) {
      console.error('🌐 Verifica tu conexión a internet y configuración de red en MongoDB Atlas');
    }
    process.exit(1);
  }
}
